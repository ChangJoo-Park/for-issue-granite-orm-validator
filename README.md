...
testing-auth is a new project using [Amber Framework](https://amberframework.org/)
...
```
shards build --production --release testing-auth
```
...
1. Fork it ( https://github.com/your-github-user/testing-auth/fork )
...
- [your-github-user](https://github.com/your-github-user) ChangJoo Park(박창주) - creator, maintainer
